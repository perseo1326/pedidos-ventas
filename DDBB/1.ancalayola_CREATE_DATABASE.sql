...
-- Schema ancalayola
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `ancalayola` DEFAULT CHARACTER SET utf8mb4 ;
USE `ancalayola` ;
...
CREATE TABLE IF NOT EXISTS `ancalayola`.`tipo_usuario` (
  ...
  `tipousuario_codigo` VARCHAR(20) NOT NULL,
  `tipousuario_nombre` VARCHAR(100) NOT NULL,
  `tipousuario_notas` VARCHAR(1000) NULL DEFAULT NULL,
  `tipousuario_status` VARCHAR(1) NOT NULL DEFAULT 'A',
...
CREATE TABLE IF NOT EXISTS `ancalayola`.`usuarios` (
  ...
  `usuarios_nombre` VARCHAR(100) NOT NULL DEFAULT '',
  `usuarios_descripcion` VARCHAR(300) NULL DEFAULT '0',
  `usuarios_status` CHAR(1) NOT NULL DEFAULT 'A',
...
CREATE TABLE IF NOT EXISTS `ancalayola`.`Pedidos` (
  ...
  `pedidos_estado` ENUM('CREACION', 'PEDIDO', 'PREPARACION', 'TERMINADO', 'ENTREGADO') NOT NULL COMMENT 'define el estado actual del pedido, EN PROCESO, TERMINADO Y ENTREGADO.',
  ...
  `pedidos_notas` VARCHAR(3000) NULL DEFAULT NULL COMMENT 'espacio reservado para notas acerca del pedido',
...
CREATE TABLE IF NOT EXISTS `ancalayola`.`presentacion` (
  ...
  `presentacion_codigo` VARCHAR(20) NOT NULL,
  `presentacion_nombre` VARCHAR(100) NOT NULL,
  `presentacion_descripcion` VARCHAR(300) NOT NULL,
  `presentacion_status` VARCHAR(1) NULL DEFAULT 'A',
...
CREATE TABLE IF NOT EXISTS `ancalayola`.`ingredientes` (
  ...
  `ingred_codigo` VARCHAR(20) NOT NULL,
  `ingred_tipo` VARCHAR(20) NULL DEFAULT NULL,
  `ingred_ingrediente` VARCHAR(100) NOT NULL,
  `ingred_descripcion` VARCHAR(300) NOT NULL,
  `ingred_presentacion` TINYINT NOT NULL,
  `ingred_imagen` VARCHAR(255) NULL DEFAULT NULL,
  `ingred_status` VARCHAR(1) NOT NULL DEFAULT 'A',
...
CREATE TABLE IF NOT EXISTS `ancalayola`.`productos` (
  ...
  `prod_status` VARCHAR(1) NOT NULL DEFAULT 'A',
  `prod_imagen` VARCHAR(300) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ancalayola`.`DetallePedido` (
  ...
  INDEX `IDX_numPedido` (`detallePedido_id` ASC) ,
