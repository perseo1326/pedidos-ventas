...
('pedido', 'camaron', 'Camarón', 'Camaron para relleno de panuchos', (SELECT presentacion_id FROM presentacion WHERE presentacion_codigo = 'und'), 'camaron.png', 'A'), 
...
('pedido', 'azucar', 'Azúcar', 'Mezcla de azúcar y queso para relleno de panuchos', (SELECT presentacion_id FROM presentacion WHERE presentacion_codigo = 'und'), 'sugar_cube.png', 'A'), 
('pedido', 'manual', 'Manual', 'Pedido de edicion manual', (SELECT presentacion_id FROM presentacion WHERE presentacion_codigo = 'indef'), 'manual.png', 'A');
