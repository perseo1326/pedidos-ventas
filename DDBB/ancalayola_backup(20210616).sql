...
-- Volcando datos para la tabla ancalayola.DetallePedido: ~121 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `Pedidos` (
  ...
  `pedidos_numTelefono` varchar(15) DEFAULT NULL COMMENT 'numero de telefono en caso de haber realizado el pedido por TELEFONO.',
  ...
  `pedidos_numTransfer` varchar(30) DEFAULT NULL COMMENT 'en caso de haberse hecho el pago por medio de transferencia, aqui estará el numero de transacción.',
...
-- Volcando datos para la tabla ancalayola.Pedidos: ~28 rows (aproximadamente)
DELETE FROM `Pedidos`;
